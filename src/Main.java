...
public class Main {
  ...
  // The time complexity is: O(n^2) where n = x
  // YOUR ANSWER HERE
  ...
  // The time complexity is: O(n) where n = length of word
  // YOUR ANSWER HERE
  ...
  // The time complexity is: O(n) where n = length of nums
  // YOUR ANSWER HERE
  ...
  // The time complexity is: O(n^2) where n = length of nums
  // YOUR ANSWER HERE
  ...
  // For the method above, it's time complexity is O(n)
  ...
  // The time complexity is: O(n) where n = length of arr
  // YOUR ANSWER HERE
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is: O(n^2) where n = length of words
  // YOUR ANSWER HERE
  ...
  // assume that each String is bounded by a constant length
  // The time complexity is: O(n) where n = length of words
  // YOUR ANSWER HERE
  ...
  // The time complexity is: O(n) where n = length of chars
  // YOUR ANSWER HERE
  ...
  // The time complexity is: O(n) where n = length of names
  // YOUR ANSWER HERE
  ...
  // What is the time complexity of this method?
  // The time complexity is: O(n^2) where n = length of wordSet
  // YOUR ANSWER HERE
  ...
  // The time complexity is: O(n) where n = length of wordlist
  // YOUR ANSWER HERE
